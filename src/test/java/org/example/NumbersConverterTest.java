...
class NumbersConverterTest {
    ...
    @CsvSource({
          ...
          "40,XL", "40,XL", "41,XLI", "42,XLII", "43,XLIII", "44,XLIV", "45,XLV", "46,XLVI", "47,XLVII", "48,XLVIII", "49,XLIX",
          "50,L", "50,L", "51,LI", "52,LII", "53,LIII", "54,LIV", "55,LV", "56,LVI", "57,LVII", "58,LVIII", "59,LIX",
          ...
          "100, C", "123,CXXIII", "296, CCXCVI", "369,CCCLXIX", "448,CDXLVIII", "578, DLXXVIII", "679, DCLXXIX", "779, DCCLXXIX", "751, DCCLI", "861,DCCCLXI", "986, CMLXXXVI",
          "1448,MCDXLVIII", "2751, MMDCCLI", "1998, MCMXCVIII", "3649, MMMDCXLIX",
          "4000,Number out of interval"
    })
    void should_convert_arabic_number_to_romain_number(int input,String expected) {
        NumbersConverter numbersConverter = new NumbersConverter();
        String actualValue = numbersConverter.convertNumberToRomanNumeral(input);
